...
execute as @e[tag=src-mgct+selected] if entity @s[type=item_frame] run function src-mgct:item_frame/toggle_invisible
execute as @e[tag=src-mgct+selected] if entity @s[type=glow_item_frame] run function src-mgct:item_frame/toggle_invisible
