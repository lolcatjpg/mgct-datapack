...
# feedback
tellraw @a[distance=..5] [{"text": "🛈 Entity selected", "color": "aqua"}, {"text": " | ", "color": "gray"}, {"text": "click here to open menu", "color": "aqua", "underlined": true, "clickEvent": {"action": "run_command", "value": "/function mgct:menu"}}]
